...
otcdocs_repo_name = 'opentelekomcloud-docs/direct-connect'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/direct-connect/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'network'
otcdocs_service_title = 'Direct Connect'
otcdocs_service_type = 'dc'
...
html_title = "Direct Connect - API Reference"
...
latex_documents = [
    ('index',
     'dc-api-ref.tex',
    u'Direct Connect - API Reference',
